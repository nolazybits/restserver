...
class ExceptionHandler 
  extends \Rest\Exceptions\BaseExceptionHandler
{
    /**
     *
     */
    ...
    public function exceptionHandler ( $exception )
    {
        ...
        header(\Rest\Http\HeaderConstants::HTTP_VERSION_1_1 . $exception->getCode() );
        header(\Rest\Http\HeaderConstants::CONTENT_TYPE_JSON);
